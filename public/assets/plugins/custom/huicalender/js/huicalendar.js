var huicalendar = function (element, options) {
    ...
    this.yearAttr = this.viewDay.getFullYear();
...
huicalendar.prototype = {
    getCalendar: function () {
        ...
        var yearTab = '<ul>';
        for (var i = 0; i < 10; i++) {
            yearTab += '<li value="' + (this.yearAttr + i) + '" class="' + (i == 1 ? 'border-top1' : '') + '">' + (this.yearAttr + i) + '</li>';
        };
        yearTab += '</ul>';
        ...
        var thead =
            ...
            '<th colspan="3" class="year" year="' + this.year + '">' + this.year + yearTab + '</th>' +
    ...
    bindEvent: function () {
        ...
        this.element.on('click', '.year', function () {
            $(this).find('ul').toggle();
            $('.month ul').hide()
            $('.year ul').show()
        })
        ...
        this.element.on('click', '.year li', function () {
            var value = $(this).attr('value');
            that.year = value;
            that.month = 1;
