<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-1 ms-lg-3">
        <!--begin::Menu- wrapper-->
        <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px  notiicon"
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
            <div class="d-flex flex-column bgi-no-repeat rounded-top"
                ...
                <h3 class="text-white fw-semibold px-9 mt-10 mb-6">Notifications
                    <span class="fs-8 opacity-75 ps-3 unreadNoti"></span>
                </h3>
                <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                    <li class="nav-item">
                        <a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab"
                            href="#kt_Appointments_notifications">Appointments</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active" data-bs-toggle="tab"
                            href="#kt_Leads_notifications_2">Leads</a>
                    </li>

                </ul>
            </div>
            <div class="tab-content">
                <div class="tab-pane fade" id="kt_Appointments_notifications" role="tabpanel">
                    <div class="scroll-y mh-325px my-5 px-8 appendAppointment">
                ...
                <div class="tab-pane fade show active" id="kt_Leads_notifications_2" role="tabpanel">
                    <!--begin::Wrapper-->

                    <div class="scroll-y mh-325px my-5 px-8 appendLead">
                    </div>
    ...
    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
            data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
            data-kt-menu-placement="bottom-end">
            <img src="{!! Auth::user()->display_picture
                ? asset('storage/' . Auth::user()->display_picture)
                : asset('assets/media/svg/files/blank-image-dark.svg') !!}  " alt="user" />
        </div>
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    <div class="symbol symbol-50px me-5">
                        <img alt="Logo" src="{!! Auth::user()->display_picture
                            ? asset('storage/' . Auth::user()->display_picture)
            ...
            <div class="menu-item px-5">
                <a href="{{ route('user.admin.view', Auth::user()->id) }}}" class="menu-link px-5">My
                    Profile</a>
            </div>
